...
---------------------------------------------------------------------------*/
// find PM100D
#define PM100D_FIND_PATTERN           "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODEL_CODE==0x8070 || VI_ATTR_MODEL_CODE==0x8078)}"
...
// STATUS BYTE bit definitions (see IEEE488.2-1992 ?1.2)
...
// STANDARD EVENT STATUS REGISTER bit definitions (see IEEE488.2-1992 ?1.5.1)
...
// QUESTIONABLE STATUS REGISTER bit definitions (see SCPI 99.0 ?)
...
// OPERATION STATUS REGISTER bit definitions (see SCPI 99.0 ?)
